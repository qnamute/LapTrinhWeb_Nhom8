            ...
            <div class="banner_inner">
				<div class="container">
					<div class="banner_content">
						...
						<h2>Website Toeic <br /></h2><h3>Ho Chi Minh University of Technology and Education</h3>
						<p>Lập trình Web - Nhóm 8 Sáng thứ 7</p>
            ...
            <div class="side_menu">
				...
				<div class="input-group">
           		...
           		<ul class="list menu_right">
					...
					<li><a href="inforAccount">Information</a></li>
					<li><a href="showListExam">Your Exam</a></li>
					<li><a href="getResult_tenDangNhap">Result</a></li>					
