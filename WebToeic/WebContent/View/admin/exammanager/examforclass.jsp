...
<html lang="en">
    ...
    <body>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                <c:forEach items="${listbt}" var="list">
                                            	    <tr class="odd gradeX">
                                                   		<td>${list.tenDeThi}</td>
                     ...
                     <div class="panel-body">
                     	<p> <button type="button" class="btn btn-warning btn-lg" data-toggle="modal" data-target="#exampleModal">Add exam for class</button></p>
                     </div>                                       
                </div>
            </div> -->
        </div>           
       ...
       <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<form action="insertBaiThi" method="post">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        <h5 class="modal-title" id="exampleModalLabel">Add exam for class</h5>
					  ...
					  <div class="table-responsive">
					  	<table class="table table-hover">
					  		...
					  		<tbody>
					  				...
					  				<th>
					  					<select class="form-control" name="exam1">
							  				<c:forEach items="${listexam}" var="list">
												<option value="${list.maDeThi}">${list.tenDeThi}</option>
											</c:forEach>	
										</select>
					  			...
					  			<tr>
					  				<th>Start time</th>
					  				<th><input type="date" class="form-control" name="starttime1"></th>
					  			</tr>	
					  			<tr>
					  				<th>End time</th>
					  				<th><input type="date" class="form-control" name="endtime1"></th>
					  			</tr>			  								  							  							  		</tbody>
					  	</table>
					  </div>			
		      </div>
